...
modules = [example0, example1, example2, example3, example4, example5, example6, example7, example8, team0, team1, team2, team3, team4, team5, team6, team7, team8, team9, team10, 
...
if __name__ == '__main__':
    scores, moves, reports = main_play([example0, example1, example2, example3, example4])   
    section0, section1, section2, section3 = reports